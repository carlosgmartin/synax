...
class AutoEncoder(BaseModule):
    ...
    def parameter_loss(self, params: dict[str, Any]) -> Array:
        encoder_loss = self.encoder.parameter_loss(params["encoder"])
        decoder_loss = self.decoder.parameter_loss(params["decoder"])
